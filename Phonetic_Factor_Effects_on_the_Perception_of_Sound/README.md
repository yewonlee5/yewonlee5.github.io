...
The three factors are **Voice onset time, Pitch, and Intensity**. The Voice Onset Time (VOT) is the difference in time between releasing and voicing. Pitch refers to the volume of sound. Intensity is defined as the power per unit area carried by the sound wave.
